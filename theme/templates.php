        ...
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
             ...
             <a data-target="#myModal" data-toggle="modal" href="" style="font-size: 14px"; > <i class="fa fa-lock"></i> User Login </a>
             <span style="margin-left: 40px;"></span>
             <a  href="http://localhost/career_guidance_portal/admin/login.php" style="font-size: 14px; target="_blank" > <i class="fa fa-lock"></i> Admin Login </a>
                      <?php } ?>
